...
class AdjuntosContenidoType extends AbstractType
{
    ...
    {
        $builder
            ->add('adjuntos','entity', array(
			    'class' => 'DestinyAppBundle:Adjuntos',
			    'label' => $this->translator->trans ('adjuntosContenido.form.name'),
			    'required' => true,))
        ;
    }
